...
public class AllMenuAdapter extends RecyclerView.Adapter<AllMenuAdapter.AllMenuViewHolder> {
    ...
    //    holder.allMenuCharges.setText(allmenuList.get(position).getImageUrl());
     //   holder.allMenuNote.setText(allmenuList.get(position).getRestorantname());
    ...
    public static class AllMenuViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView allMenuName, allMenuRating, allMenuCharges, allMenuPrice;
